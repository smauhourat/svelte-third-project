...
var app = (function () {
    ...
    /* src\Product.svelte generated by Svelte v3.49.0 */
    ...
    function create_if_block$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h3, file$2, 18, 4, 333);
    		},
    ...
    function create_fragment$2(ctx) {
    	...
    	let mounted;
    	let dispose;
    	let if_block = /*bestseller*/ ctx[2] && create_if_block$1(ctx);
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h1, file$2, 15, 2, 273);
    			add_location(h2, file$2, 16, 2, 292);
    			add_location(button0, file$2, 20, 2, 363);
    			add_location(button1, file$2, 21, 2, 415);
    			add_location(article, file$2, 14, 0, 261);
    		},
    ...
    function fallback_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(button, file$1, 16, 6, 355);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div0, file$1, 6, 0, 121);
    			attr_dev(header, "class", "svelte-nheja4");
    			add_location(header, file$1, 8, 2, 211);
    			attr_dev(div1, "class", "content");
    			add_location(div1, file$1, 11, 2, 264);
    			add_location(footer, file$1, 14, 2, 313);
    			attr_dev(div2, "class", "modal svelte-nheja4");
    			add_location(div2, file$1, 7, 0, 188);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    			...
    			if (footer_slot) {
    				if (footer_slot.p && (!current || dirty & /*$$scope*/ 2)) {
    					update_slot_base(
    						...
    						!current
    						? get_all_dirty_from_scope(/*$$scope*/ ctx[1])
    						: get_slot_changes(footer_slot_template, /*$$scope*/ ctx[1], dirty, get_footer_slot_changes),
    ...
    function instance$1($$self, $$props, $$invalidate) {
    	...
    	const click_handler = () => dispatch("close-modal");
    ...
    function create_each_block(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(24:0) {#each products as product}",
    		ctx
    	});
    ...
    function create_if_block(ctx) {
    	...
    	modal.$on("close-modal", /*close_modal_handler*/ ctx[4]);
    ...
    // (31:2) <Modal     on:close-modal={() => {       showModal = false;     }}   >
    function create_default_slot(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(31:2) <Modal     on:close-modal={() => {       showModal = false;     }}   >",
    		ctx
    	});
    ...
    function create_footer_slot(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(button, file, 37, 4, 680);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, button, anchor);
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(button, file, 27, 0, 468);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function instance($$self, $$props, $$invalidate) {
    	...
    	return [showModal, products, click_handler, click_handler_1, close_modal_handler];
    }

...
var app = (function () {
    ...
    function fallback_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(button, file$1, 21, 6, 557);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(div0, "class", "backdrop svelte-1ox63r8");
    			add_location(div0, file$1, 7, 0, 144);
    			attr_dev(header, "class", "svelte-1ox63r8");
    			add_location(header, file$1, 9, 2, 234);
    			attr_dev(div1, "class", "content");
    			add_location(div1, file$1, 12, 2, 287);
    			add_location(p, file$1, 16, 4, 366);
    			add_location(button, file$1, 17, 4, 428);
    			attr_dev(div2, "class", "disclaimer svelte-1ox63r8");
    			add_location(div2, file$1, 15, 2, 336);
    			add_location(footer, file$1, 19, 2, 497);
    			attr_dev(div3, "class", "modal svelte-1ox63r8");
    			add_location(div3, file$1, 8, 0, 211);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function instance$1($$self, $$props, $$invalidate) {
    	...
    	const click_handler_2 = () => dispatch("close-modal");
    ...
    // (25:0) {#each products as product}
    function create_each_block(ctx) {
    	let product;
    	let current;
    	const product_spread_levels = [/*product*/ ctx[6]];
    	let product_props = {};
    	...
    	const block = {
    		...
    		p: function update(ctx, dirty) {
    			...
    			? get_spread_update(product_spread_levels, [get_spread_object(/*product*/ ctx[6])])
    			: {};
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(25:0) {#each products as product}",
    		ctx
    	});
    ...
    function create_if_block(ctx) {
    	...
    	modal.$on("close-modal", /*close_modal_handler*/ ctx[5]);
    	...
    	const block = {
    		...
    		p: function update(ctx, dirty) {
    			...
    			if (dirty & /*$$scope, closeable, showModal*/ 517) {
    ...
    // (32:2) <Modal     on:close-modal={() => {       showModal = false;     }}     let:didAgree={closeable}   >
    function create_default_slot(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(32:2) <Modal     on:close-modal={() => {       showModal = false;     }}     let:didAgree={closeable}   >",
    		ctx
    	});
    ...
    function create_footer_slot(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(button, file, 39, 4, 734);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, button, anchor);
    			append_dev(button, t);
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(button, file, 28, 0, 493);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
